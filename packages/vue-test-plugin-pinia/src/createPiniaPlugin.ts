...
import type { PiniaPluginOptions, PluginFactoryOptions } from "@testforge/vue-test-core";
 ...
 */
export function createPiniaPlugin(options: PluginFactoryOptions<Pinia, PiniaPluginOptions>): Pinia {
