...
import { createI18nPlugin as originalCreateI18nPlugin } from '@testforge/vue-test-plugin-i18n/src/createI18nPlugin'
import { createPiniaPlugin as originalCreatePiniaPlugin } from '@testforge/vue-test-plugin-pinia/src/createPiniaPlugin'
import { createRouterPlugin as originalCreateRouterPlugin } from '@testforge/vue-test-plugin-router/src/createRouterPlugin'
...
describe('testComponentFactory Integration', () => {
    ...
    beforeEach(() => {
        ...
        jest.doMock(
            '@testforge/vue-test-plugin-i18n/src/createI18nPlugin',
            () => ({
                createI18nPlugin: mockCreateI18nPlugin,
            })
        )
        jest.doMock(
            '@testforge/vue-test-plugin-pinia/src/createPiniaPlugin',
            () => ({
                createPiniaPlugin: mockCreatePiniaPlugin,
            })
        )
        jest.doMock(
            '@testforge/vue-test-plugin-router/src/createRouterPlugin',
            () => ({
        ...
        const { presets } = require('./utils/mockPresets')
